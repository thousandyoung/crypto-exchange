...
import com.howellyoung.exchange.bean.OrderRequestBean;
...
import com.howellyoung.exchange.service.HistoryService;
import com.howellyoung.exchange.service.SendEventService;
import com.howellyoung.exchange.service.TradingEngineApiProxyService;
import com.howellyoung.exchange.util.AbstractApiController;
import com.howellyoung.exchange.util.IdUtil;
import com.howellyoung.exchange.util.JsonUtil;
import com.howellyoung.exchange.util.UserContext;
...
public class TradingApiController extends AbstractApiController {
    ...
    private final TradingEngineApiProxyService tradingEngineApiProxyService;
    ...
    public TradingApiController(SendEventService sendEventService, HistoryService historyService, RedisService redisService, ObjectMapper objectMapper, TradingEngineApiProxyService tradingEngineApiProxyService) {
        this.sendEventService = sendEventService;
        this.historyService = historyService;
        this.redisService = redisService;
        this.objectMapper = objectMapper;
        this.tradingEngineApiProxyService = tradingEngineApiProxyService;
    }
    ...
    public List<SimpleMatchingDetailRecord> getOrderMatchingDetails(@PathVariable("orderId") Long orderId) throws Exception {
        final Long userId = UserContext.getRequiredUserId();
        // 查找活动Order:
        ...
        return this.historyService.getHistoryMatchingDetails(orderId);
    }
            ...
            if (message.refId != null) {
                ...
                if (deferred != null) {
                    if (message.error != null) {
                        ...
                        ResponseEntity<String> resp = new ResponseEntity<>(JsonUtil.convertObjectToJsonString(message.result),
                                HttpStatus.OK);
                        deferred.setResult(resp);
                    }
                }
