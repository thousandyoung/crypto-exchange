...
public final class JsonUtil {
    ...
    public static void writeObjectAsJsonToOutputStream(OutputStream output, Object obj) throws IOException {
        try {
    ...
    public static String convertObjectToPrettyPrintedJsonString(Object obj) {
        try {
